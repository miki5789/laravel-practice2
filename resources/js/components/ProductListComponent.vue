      ...
      <div class="row">
        ...
        <div v-for="(product, index) in products" :key="index" class="col-md-3 mb-4">
          ...
          <router-link :to="{name: 'product.detail', params: {product_master_id: product.product_master_id}}" class="product-link">
            <img :src="(product.product_image_master.length > 0 && product.product_image_master[0].image_path1) ? product.product_image_master[0].image_path1 : '/images/default.png'" alt="product_image" class="img-fluid">
